                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="post_address" name="post_address" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="prog_choice" id="prog_choice" cols="30" rows="3"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="school_attended" id="school_attended" />
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="control-label" for="year_started">Year Started</label>
                                            <input class="form-control" type="text" name="year_started" id="year_started" />
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="control-label" for="year_completed">Year Completed</label>
                                            <input class="form-control" type="text" name="year_completed" id="year_completed" />
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" name="certificate_upload" id="certificate_upload">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="one_referee_name" id="one_referee_name" />
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="control-label" for="one_referee_phone">1st Referee Phone</label>
                                            <input class="form-control" type="number" name="one_referee_phone" id="one_referee_phone" />
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="control-label" for="one_referee_email">1st Referee Email</label>
                                            <input class="form-control" type="text" name="one_referee_email" id="one_referee_email"/>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="control-label" for="one_referee_occupation">1st Referee Occupation</label>
                                            <input class="form-control" type="text" name="one_referee_occupation" id="one_referee_occupation" />
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label class="control-label" for="one_referee_address">1st Referee Address</label>
                                            <input class="form-control" type="text" name="one_referee_address" id="one_referee_address" />
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="control-label" for="two_referee_name">2nd Referee Name</label>
                                            <input class="form-control" type="text" name="two_referee_name" id="two_referee_name" />
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="control-label" for="two_referee_phone">2nd Referee Phone</label>
                                            <input class="form-control" type="number" name="two_referee_phone" id="two_referee_phone" />
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="control-label" for="two_referee_email">2nd Referee Email</label>
                                            <input class="form-control" type="text" name="two_referee_email" id="two_referee_email"/>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="control-label" for="two_referee_occupation">2nd Referee Occupation</label>
                                            <input class="form-control" type="text" name="two_referee_occupation" id="two_referee_occupation" />
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label class="control-label" for="two_referee_address">2nd Referee Address</label>
                                            <input class="form-control" type="text" name="two_referee_address" id="two_referee_address" />
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label class="control-label" for="two_referee_address">Undertaking and Completeness Check</label>
                                            <p>I can confirm that information entered in this form are true and I should be held liable when any information is found to be untrue. <small>NB: Select "YES" this box if you are truly done filling the form.</small></p>
                                            <select class="form-control" name="form_complete" id="form_complete" >
                                                <option value="">Select Option</option>
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                            </select>
