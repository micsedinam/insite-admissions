    ...
    <div class="py-1">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-blue-300 border-b border-gray-200 h-full">
                    <!-- component -->
                    ...
                    <div class="h-screen">
                        ...
                        <div x-data="app()" x-cloak>
                                    ...
                                    <div class="border-b-2 py-4">
                                        ...
                                        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                                            <div class="flex-1">
                                                ...
                                                <div x-show="step === 2">
                                                    <div class="text-lg font-bold text-gray-700 leading-tight">Programme & Department</div>
                                                </div>

                                                <div x-show="step === 3">
                                                    <div class="text-lg font-bold text-gray-700 leading-tight">Institution Details</div>
                                                </div>

                                                <div x-show="step === 4">
                                                    <div class="text-lg font-bold text-gray-700 leading-tight">Referees</div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="py-2">	
                                        <div x-show.transition.in="step === 1">
                                            ...
                                            <div class="grid grid-rows-3 grid-flow-col gap-4">
                                                <div class="form-group flex flex-col mb-4 row-span-3">
                                                    <label class="mb-2 font-bold text-lg text-gray-700" for="firstname">First Name</label>
                                                    <input class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" type="text" id="firstname" name="firstname" required/>
                                                </div>

                                                <div class="form-group flex flex-col mb-4 row-span-3">
                                                    <label class="mb-2 font-bold text-lg text-gray-700 block" for="lastname">Last Name</label>
                                                    <input class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" type="text" id="lastname" name="lastname" required/>
                                                </div>
                                            </div>

                                            <div class="form-group flex flex-col mb-4 row-span-3">
                                                <label class="mb-2 font-bold text-lg text-gray-700" for="othername">Other Names</label>
                                                <input class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" type="text" id="othername" name="othername"/>
                                            </div>

                                            <div class="grid grid-rows-3 grid-flow-col gap-4">
                                                <div class="form-group flex flex-col mb-4 row-span-3">
                                                    <label class="mb-2 font-bold text-lg text-gray-700 block" for="dob">Date of Birth</label>
                                                    <input class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" type="date" id="dob" name="dob" required />
                                                </div>
                                                <div class="form-group flex flex-col mb-4 row-span-3">
                                                    <label class="mb-2 font-bold text-lg text-gray-700 block" for="phone">Phone</label>
                                                    <input class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" type="number" name="phone" id="phone" required />
                                                </div>
                                                
                                            </div>

                                            <div class="form-group flex flex-col mb-4 row-span-3">
                                                <label class="mb-2 font-bold text-lg text-gray-700 block" for="email">Email Address</label>
                                                <input class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" type="email" name="email" id="email" required />
                                            </div>

                                            <div class="form-group flex flex-col mb-4 row-span-3">
                                                <label class="mb-2 font-bold text-lg text-gray-700 block" for="post_address">Post Address</label>
                                                <input class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" type="text" id="post_address" name="post_address" required/>
                                            </div>

                                            <div class="grid grid-rows-3 grid-flow-col gap-4">
                                                <div class="form-group flex flex-col mb-4 row-span-3">
                                                    <label class="mb-2 font-bold text-lg text-gray-700 block" for="gender">Gender Names</label>
                                                    <select class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium form-select" name="gender" id="gender" required>
                                                ...
                                                <div class="form-group flex flex-col mb-4 row-span-3">
                                                    <label class="mb-2 font-bold text-lg text-gray-700 block" for="country">Country</label>
                                                    <input class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" type="text" id="country" name="country" required/>
                                                </div>
                                                <div class="form-group flex flex-col mb-4 row-span-3">
                                                    <label class="mb-2 font-bold text-lg text-gray-700 block" for="nationality">Nationality</label>
                                                    <input class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" type="text" id="nationality" name="nationality" required/>
                                                </div>
                                            </div>

                                            <div class="grid grid-rows-3 grid-flow-col gap-4">
                                                <div class="form-group flex flex-col mb-4 row-span-3">
                                                    <label class="mb-2 font-bold text-lg text-grey-darkest" for="marital_status">Marital Status</label>
                                                    <select class="border rounded-xl py-2 px-3 text-grey-darkest form-select block w-full" name="marital_status" id="marital_status" required>
                                                        <option value="">Select</option>
                                                ...
                                                <div class="form-group flex flex-col mb-4 row-span-3">
                                                    <label class="mb-2 font-bold text-lg text-grey-darkest" for="children">Number of Children</label>
                                                    <input class="border rounded-xl py-2 px-3 text-grey-darkest" type="number" name="children" id="children"/>
                                                </div>
                                                <div class="form-group flex flex-col mb-4 row-span-3">
                                                    <label class="mb-2 font-bold text-lg text-grey-darkest" for="residence">Place of Residence</label>
                                                    <input class="border rounded-xl py-2 px-3 text-grey-darkest" type="text" name="residence" id="residence" required/>
                                                </div>
                                            </div>
                            ...
                            <!-- Bottom Navigation -->	
                            <div class="fixed bottom-0 left-0 right-0 py-5 bg-yellow-500 shadow-md" x-show="step != 'complete'">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <div class="w-1/2 text-right">
                                            <button
                                                x-show="step < 4"
                                                @click="step++"
                                                class="w-32 focus:outline-none border border-transparent py-2 px-5 rounded-lg shadow-sm text-center text-white bg-blue-600 hover:bg-blue-500 font-medium" 
                                            >Next</button>

                                            <button
                                                @click="step = 'complete'"
                                                x-show="step === 4"
                                                class="w-32 focus:outline-none border border-transparent py-2 px-5 rounded-lg shadow-sm text-center text-white bg-blue-800 hover:bg-blue-600 font-medium" 
                                            >Complete</button>
                                        </div>
                                    </div>
                                </div>
